There are no direct APIs for implementing Linear Regression Algorithm. There are some alternative ways of solving this problem using Hadoop MapReduce and Python or R packages.
